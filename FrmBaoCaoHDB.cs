...
namespace QuanLyTiVi
{
    public partial class FrmBaoCaoHDB : Form
    {
        ...
        private void btnIn_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["C5:C5"].Value = "Quý " + cbbQuy.SelectedItem;
            exRange.Range["D5:D5"].MergeCells = true;
            exRange.Range["D5:D5"].Value =  "Năm"+cbbNam.Text;
            ...
            exRange.Range["B7:B7"].Value = "Số HDB";
            exRange.Range["C7:C7"].Value = "Mã NV";
            exRange.Range["D7:D7"].Value = "Mã Khách";
            exRange.Range["E7:E7"].Value = "Ngày Bán";
            exRange.Range["F7:F7"].Value = "Thuế";
            exRange.Range["G7:G7"].Value = "Tổng tiền";
        ...
        private void btnBaoCao_Click_1(object sender, EventArgs e)
        {
            ...
            if (cbbQuy.Text == "")
            {
                MessageBox.Show("Bạn phải nhập quý", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                cbbQuy.Focus();
                return;
            }

            if (cbbQuy.Text.Trim() != "" && cbbNam.Text.Trim() != "")
            {
                sql = "SELECT * FROM HoaDonBan WHERE datepart(QUARTER,(NgayBan))='" + cbbQuy.Text.Trim() + "'AND datepart(YEAR,(NgayBan))='" + cbbNam.Text.Trim() + "'";
            ...
            else
            {
                ...
                //Cập nhật lại tổng tiền cho báo cáo
                    ...
                    tong = Convert.ToDouble(functions.GetFieldValues("SELECT sum(TongTien)*1000000 FROM HoaDonBan WHERE datepart(YEAR,(NgayBan))=N'" + cbbNam.Text + "' AND datepart(QUARTER,(NgayBan))=N'" + cbbQuy.Text + "'"));
